...
from tingna.tools.util import LogUtil,FileUtil,DBUtil,TimeUtil
...
class APIUtil:
    ...
    def get_session(cls):
        ...
        login_url_data =FileUtil.get_txt_line('..\\conf\\login')
        for login_url in login_url_data:
