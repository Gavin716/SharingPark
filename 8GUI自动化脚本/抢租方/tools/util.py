...
class TimeUtil:
    ...
    def get_filename_time(cls):
        ...
        获取系统时间    返回规定格式的时间字符串
       :param :
       :return:  时间字符串格式为  %Y%m%d_%H%M%S（20201010_1010
       """
    ...
    def get_standard_format_time(cls):
        ...
        获取系统时间   返回规定格式的时间字符串
       :param :
       :return: 时间字符串格式为  %Y%m%d_%H%M%S（2020-10-10 10-10
       """
...
class DBUtil:
    ...
    logger = LogUtil.get_logger(os.path.join(os.getcwd(), 'lib_util'))

    def __init__(self, option):
        self.db_info = eval(
            FileUtil.get_ini_value('..\\conf\\base.ini', 'mysql',f'{option}'))
...
if __name__ == '__main__':
    print(FileUtil.get_test_info('..\\conf\\test_info.ini', 'sales', 'scan_barcode_api'))